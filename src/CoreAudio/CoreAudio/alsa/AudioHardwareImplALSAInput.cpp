#include "AudioHardwareImplALSAInput.h"

AudioHardwareImplALSAInput::AudioHardwareImplALSAInput(AudioObjectID myId) : AudioHardwareImplALSA(myId)
{

}

OSStatus
AudioHardwareImplALSAInput::getPropertyData(const AudioObjectPropertyAddress* inAddress, UInt32 inQualifierDataSize,
...
OSStatus
AudioHardwareImplALSAInput::setPropertyData(const AudioObjectPropertyAddress* inAddress, UInt32 inQualifierDataSize,
...
AudioHardwareStream* AudioHardwareImplALSAInput::createStream(AudioDeviceIOProc callback, void* clientData)
{
